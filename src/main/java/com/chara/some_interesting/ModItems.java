...
import com.chara.some_interesting.component.ModComponent;
...
public class ModItems{
    ...
    public static final ResourceKey<CreativeModeTab> CUSTOM_CREATIVE_TAB_KEY = ResourceKey.create(
            BuiltInRegistries.CREATIVE_MODE_TAB.key(), Identifier.fromNamespaceAndPath(SomeInteresting.MOD_ID,
                    "creative_tab")
    );
    ...
    public static final CreativeModeTab CUSTOM_CREATIVE_TAB = FabricCreativeModeTab.builder()
            ...
            .title(Component.translatable("creativeTab.some-interesting")) //这里是指定标签页在本地显示文本名称时使用的key，用这个key去对应真正的name
    ...
    public static final TagKey<Item> EMERADL_TAG = TagKey.create(BuiltInRegistries.ITEM.key(),Identifier.fromNamespaceAndPath(SomeInteresting.MOD_ID,"emerald_repair_tag"));
