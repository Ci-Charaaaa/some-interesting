...
import static com.chara.some_interesting.ModItems.register;
...
public class GuiditeArmorMaterial {
    ...
    //注册物品：盔甲材料
    public static final ResourceKey<EquipmentAsset> EMERALD_ARMOR_MATERIAL_KEY = ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.fromNamespaceAndPath(SomeInteresting.MOD_ID, "emerald"));
